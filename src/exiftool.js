...
import parseXmp from './xmpParser';
  ...
  var EXIF = {};
        ...
        while (iOffset < iLength) {
            ...
            if (iMarker == 22400) {
                ...
                if (headerAsString.indexOf("http://ns.adobe.com/xap/1.0/") != -1) {
                    ...
                    const oXmpData = parseXmp(sXmpData);

                    if(oXmpData) {
                    Object.assign(oExifData, oXmpData);
    ...
    function _findEXIFinJPEG(oFileText) {
        return findEXIFinJPEG(new BinaryFile(oFileText));
    }

    export { getExifFromLocalFileUsingNodeFs, _findEXIFinJPEG as findEXIFinJPEG };
